...
# DeepSORT txt format:
# frame,id,x1,y1,x2,y2,1,-1,-1,-1 where,
# frame: frame number
...
parser.add_argument('-t', type=int, help='threshold of number of observations', required=True)
...
def visualize_results(cap, object_id, tracker, video_name, file_name, checkpoint_file):
    ...
    for k, v in appereances.items():
        ...
        if (button == ord('l') or button == ord('r')):
            ...
            v_name = save_individual_video('data_labeler', video_name, k,
                                           '/Users/david/workspace/thesis/thesis_repo/P_UAH_PREVENTION/data_labeler/selected_videos/',
                                           frames, (224, 224))
